...
<div class='container' style="position: absolute;top: 30%;">
  <div class='signup'>
     <form action="/Augmented/UploadGal" method="post" enctype="Multipart/form-data">
 ...
 <%  String sql="select max(imgid) from images";
  con=CrudOperation.createConnection();
    try
    {
		...
		System.out.println(rgid);
		 String strs="select name from images where imgid=?";
		    try
		    {
...
<img class="display" src="<%=actimage %>" width='640' height='367'>
