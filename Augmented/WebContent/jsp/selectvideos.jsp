...
String sfin="select * from videos where userid=?";
try
{
	flag++;
...
{ 
    ...
    i=reglist.get(j);	
	%>
	<form action="/Augmented/jsp/selectvideos1.jsp" method="post">
	...
	<video controls src="<%=imglist.get(j)%>" id="img1" style="psition:absolute;top:25%;width: 30%;height:30%" type="video/mp4"></video>
<%
}
	...
	<img src="<%=imglist.get(t)%>" id="img1" style="psition:absolute;top:25%;width: 33%;height:33%">
     ...
     --%>
      ...
      <div class="big-buttons-col1">
						<ul>
							<li><input class="b-btnblue" type="submit" value="SELECT VIDEOS" /></li>
