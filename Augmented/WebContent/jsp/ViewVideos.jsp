...
String uid=request.getParameter("txtvid");
System.out.print("videos"+uid);
...
<a href="<%=reglist.get(j) %>" title="<%=namelist.get(j)%>"> 
	<video controls src="<%=reglist.get(j) %>" style="position:relative;top:25%;width:20%;height:30%;left:7%" alt="" type="video/mp4"></video> 
